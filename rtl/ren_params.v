...
`define fpHALF  {1'b0, 5'b01110 , 16'h8000}   // 0.5f
`define fpONE  {1'b0, 5'b01111 , 16'h8000}   // 1.0f
`define fpONEHALF  {1'b0, 5'b01111 , 16'h8800}  // 1.5f
`define fpTWO  {1'b0, 5'h10 , 16'h8000}  // 2.0f
`define fpTWOHALF  {1'b0, 5'b10000 , 16'h8400}  // 2.5f
`define fpTHREE  {1'b0, 5'b10000 , 16'h8800}  // 3.0f
`define fpTHREEHALF  {1'b0, 5'b10000 , 16'h8C00}  // 3.5f
